...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin, WidgetsBindingObserver{
  ...
  void initState() {
    ...
    player1.play(
        DeviceFileSource('/storage/emulated/0/sound/AUD-20230412-WA0001.mp3'));
    setAudio();
      ...
      ..addStatusListener((status) async {
        if (status == AnimationStatus.completed) {
          ...
          await player2.play(DeviceFileSource(
              '/storage/emulated/0/sound/1. Alphabet Falling in Water-Fallen Text.mp3'));
        }
    ...
    _timer = Timer.periodic(const Duration(seconds: 10), (timer) async {
      ...
      if (isCharMatched) {
        player1.play(DeviceFileSource(
            '/storage/emulated/0/sound/AUD-20230412-WA0001.mp3'));
        setAudio();
        isCharMatched = false;
      }
                  ...
                  onSubmitted: (value) async {
                    if (value == String.fromCharCode(char.value)) {
                      ...
                      player3.play(DeviceFileSource(
                          '/storage/emulated/0/sound/6. Exellent Performance.mp3'));
                      ...
                      player4.play(DeviceFileSource(
                          '/storage/emulated/0/sound/4. Poor Performance-Boo Soud.mp3'));
